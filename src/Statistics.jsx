...
const humidityChartSeries = [
    {
        name: "Humidity",
        data: [
            60, 20, 10, 13, 26, 19, 20, 21, 32, 23, 30, 50, 20, 60, 12, 15, 40, 67,
            21, 75, 80, 85, 90,
        ], // Example data
    },
];
    ...
    series: [
        {
            ...
            data: [{ value: 42, name: "Humidity" }], // Example data
            axisLine: {
                lineStyle: {
                    color: [
                        [0.2, "#67e0e3"],
...
const ChannelItem = ({ src, alt, channel, degree, degreeColor }) => (
    <div className="bg-white flex flex-1 items-center gap-2 rounded-sm p-3 shadow-md">
        ...
        <div className={`${degreeColor} font-semibold text-[1.5rem]`}>
            {degree} °C
        </div>
    </div>
);
...
const RadialGauge = ({ options }) => (
    <div className="bg-white h-[300px] shadow-sm flex-1">
...
export const Statistics = () => (
    <div id="parent-container" className="bg-gray-200">
        ...
        <div className="flex justify-start gap-3 mt-4 pl-4">
            <button className="bg-white rounded-sm py-1 px-3 shadow-sm">HOME</button>
            <button className="bg-white rounded-sm py-1 px-3 shadow-sm">
                LAB ANALYTICS
            </button>
            <button className="bg-white rounded-sm py-1 px-3 shadow-sm">
                ALARM SETTINGS
        ...
        <div
            id="parent-main-body-container"
            className="flex flex-col lg:flex-row gap-4 p-4 bg-gray-200"
        >
            {/* Left side grid: Channels container and Humidity Meter */}
            <div id="left-grid" className="flex flex-col lg:w-[30%]">
                {/* Channels container */}
                <div
                    id="channels-container"
                    className="bg-gray-200 border-none flex-1"
                >
                    <div id="channels-list" className="flex flex-col gap-4 bg-gray-200 h-[380px]">
                        <ChannelItem
                            src={tempMax}
                            alt="max temperature"
                            channel="Channel 1"
                            degree="20.9"
                            degreeColor="text-red-600"
                        />
                        <ChannelItem
                            src={tempLow}
                            alt="min temperature"
                            channel="Channel 2"
                            degree="18.99"
                            degreeColor="text-blue-400"
                        />
                        <ChannelItem
                            src={tempMedium}
                            alt="medium temperature"
                            channel="Channel 3"
                            degree="21.11"
                            degreeColor="text-red-600"
                        />
                        <ChannelItem
                            ...
                            channel="Channel 4"
                            degree="20.37"
                            degreeColor="text-black"
                        />
                    </div>
                </div>

                {/* Humidity Meter */}
                <div id="humidity-meter" className="bg-white shadow-sm flex-1 mt-[10px]">
            ...
            <div id="right-grid" className="flex flex-col space-y-4 lg:w-[70%]">
                ...
                <div
                    ...
                    className="bg-white p-4 shadow-sm flex-1 h-[370px]"
                >
